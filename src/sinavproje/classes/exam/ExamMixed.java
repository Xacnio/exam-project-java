...
public class ExamMixed extends Exam {
    private List<Question> questions = new ArrayList<Question>();

    public ExamMixed(String name, List<Question> questions) {
        super(name);
        setType(ExamType.MIXED);
    ...
    protected void generateQuestions(List<Question> questions) {
        ...
        List<Question> testQuestions = Main.data.search("", "", new String[]{}, "", "", "");
        for(int i = 0; i < 10; i++) Collections.shuffle(testQuestions);
        int puan = 0;
